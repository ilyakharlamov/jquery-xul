...
test("jQuery.makeArray", function(){
    ...
    if (jQuery.isXul()) {
    	equal( jQuery.makeArray(jQuery('box>*'))[0].nodeName.toUpperCase(), "HEAD", "Pass makeArray a jQuery object (xul)" );
       	equal( jQuery.makeArray(document.getElementsByAttribute("name","PWD")).slice(0,1)[0].name, "PWD", "Pass makeArray a nodelist (xul)" );
